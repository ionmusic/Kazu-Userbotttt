...
while 0 < 6:
    _DEVS = get(
        "https://raw.githubusercontent.com/iamuput/eizy/UputtNande/DEVS.json"
    )
...
INLINE_PIC = (os.environ.get("INLINE_PIC")
              or "https://telegra.ph/file/d88707f29d1bb4f9a42c7.jpg")
...
ch = str(b64decode("QG9oZ2l0dW5paGg="))[2:15]
gc = str(b64decode("QFVwdXR0c3VwcG9ydA=="))[2:17]
    ...
    try:
        ...
        logoyins = random.choice(
                [
                    ...
                    "https://telegra.ph/file/f4c1d8888bf604781c163.jpg",
                    "https://telegra.ph/file/d88707f29d1bb4f9a42c7.jpg",
                    "https://telegra.ph/file/d0dd091e9c2b6b942b260.jpg",
                ]
        )
        cmd = CMD_HANDLER
                ...
                result = builder.article(
                    ...
                    buttons=[
                        [
                            custom.Button.url(
                                "Bᴏᴛ Sᴛʀɪɴɢ",
                                url="https://t.me/Uputtstringbot?start="),
                            custom.Button.url(
                                "Sᴛʀɪɴɢ Rᴇᴘʟɪᴛ",
